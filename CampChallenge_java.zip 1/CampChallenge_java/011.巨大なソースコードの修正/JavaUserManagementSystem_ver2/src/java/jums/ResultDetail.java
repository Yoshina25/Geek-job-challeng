...
public class ResultDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{       
            ...
            /*クエストリングの値をセッションに格納する*/
            HttpSession UserID =request.getSession();
            UserID.setAttribute("userID",request.getParameter("id"));  
            
            /*セッションを受け取り、ID検索の引数とする。*/  
            searchData.setUserID(Integer.parseInt(UserID.getAttribute("userID").toString()));
