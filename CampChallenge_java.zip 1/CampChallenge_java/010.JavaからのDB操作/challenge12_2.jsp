 ...
 * @author yoshina
 */
@WebServlet(urlPatterns = {"/challenge12_2"})
public class challenge12_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Age = request.getParameter("ag");
         ...
         st = cn.prepareStatement("select * from profiles where name like ? or age = ? or birthday = ? ");
            st.setString(1,"%"+name+"%");
            st.setInt(2, age);
         ...
         out.println("下記の情報が取得できました。"+"<br>");
          ...
          while (rs.next()){
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet challenge12_2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet challenge12_2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
