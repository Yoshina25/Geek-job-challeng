...
//        String nm = request.getParameter("Name");
        ...
        try{
            ...
            //HTMLからデータベースへデータを挿入する。
                st = cn.prepareStatement("insert into profiles values(?,?,?,?,?)");
                st.setInt(1,Integer.parseInt(request.getParameter("ID")));
                st.setString(2,request.getParameter("Nm"));
                st.setString(3,request.getParameter("tll") );
                st.setInt(4,Integer.parseInt(request.getParameter("ag")));
                st.setString(5,request.getParameter("brthdy"));
